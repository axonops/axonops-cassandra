# axonops-cassandra - CLAUDE.md

## Project Overview

Generic repository scaffolded from `axonops-cassandra` with `--type other`. Use this type for repos that don't fit the standard stacks (Ansible, Terraform, Go, Python, combined): documentation collections, configuration bundles, scripts, prototypes, design assets, etc.
...
## Recent Progress
- Initial scaffold from `axonops-cassandra`
